...
> **Демо для заказчиков:** автономная версия панели одним HTML-файлом, без
> разворачивания n8n и остальных сервисов — см. [`demo/`](demo/README.md).
> Собранный файл: `demo/dist/vpn-helpdesk-demo.html` (открывается двойным кликом).
